defmodule AccountingWeb.TaskControllerTest do
  use AccountingWeb.ConnCase

  import Accounting.TasksFixtures

  @create_attrs %{credit_cost: 42, debit_cost: 42, public_id: "some public_id"}
  ...
  describe "update task" do
    ...
    test "redirects when data is valid", %{conn: conn, task: task} do
      ...
      assert html_response(conn, 200) =~ "some updated public_id"
    end
